...
<header>
    <div class="jumbotron jumbotron-fluid bg-pattern bg-light">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2 class="text-muted">Author : {{ $author->name }}</h2>
                    <small class="text-muted">Memiliki {{$posts->total()}} Post</small>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="animated card card-shadow fadeIn">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('author_post', $post->authorId->username) }}" class="link--black card-author">
                                <img src="{{ $author->avatar }}" alt="$author->name" class="avatar-post"> {{ $author->name }}</a>
                        </div>
                    </div>
                </div>
                @endforeach @else
